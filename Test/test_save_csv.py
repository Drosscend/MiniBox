...
class TestGenerateCSV(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tracked_objects.add(1, 50, 50, 100, 100, 0)
        self.tracked_objects.add(2, 50, 50, 100, 100, 0)
        self.tracked_objects.add(3, 50, 50, 100, 100, 0)
        self.tracked_objects.add(4, 50, 50, 100, 100, 0)
    ...
    def test_writeFileContent2(self):
        ...
        new_tracking.add(1, 50, 50, 100, 100, 1)
        new_tracking.add(2, 50, 50, 100, 100, 1)
        new_tracking.add(3, 50, 50, 100, 100, 0)
        new_tracking.add(4, 50, 50, 100, 100, 0)
        new_tracking.add(5, 50, 50, 100, 100, 1)
