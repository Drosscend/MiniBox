...
parser.add_argument('-n', '--only_new', help='Enregistre dans le CSV uniquement si une nouvelle personne est détecté',
...
if __name__ == "__main__":
    ...
    detect.main(args.webcam, args.classes, args.interval, args.show, args.debug, args.only_new)
